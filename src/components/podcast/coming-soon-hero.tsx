...
export function ComingSoonHero() {
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-[#FDFBF7] pt-24">
      ...
      <div className="container-custom relative z-10 py-12 md:py-20 text-center">
        ...
        <motion.p
          ...
          className="font-script text-2xl md:text-3xl text-gray-500 mb-6"
        >
        ...
        <motion.p
          ...
          className="text-gray-600 leading-relaxed text-base md:text-lg max-w-xl mx-auto mb-10"
        >
